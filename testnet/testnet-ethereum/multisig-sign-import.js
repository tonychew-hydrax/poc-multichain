...
var EthSignSignature = require("@safe-global/protocol-kit/dist/src/utils/signatures/SafeSignature");
var EthSafeTransaction = require("@safe-global/protocol-kit/dist/src/utils/transactions/SafeTransaction");
...
async function main() {
    ...
    let stringTx = safeTransactionToString(signedTxArray[signedTxArray.length - 1])
